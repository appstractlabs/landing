    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <Button variant="ghost" className="hover:bg-transparent hover:text-primary p-0 text-muted-foreground m-0 text-sm text-center">{t("trigger")}</Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-lg max-h-[85vh] overflow-y-auto hide-scrollbar">
                ...
                <div className="space-y-4 text-sm text-white">
                    ...
                    <ul className="list-disc pl-5">
                        <li>{ t("sections.1.a_items.0") }</li>
                        <li>{ t("sections.1.a_items.1") }</li>
                        <li>{ t("sections.1.a_items.2") }</li>
                        <li>{ t("sections.1.a_items.3") }</li>
                    </ul>
                    <p><strong>{ t("sections.1.b_title") }</strong></p>
                    <ul className="list-disc pl-5">
                        <li>{ t("sections.1.b_items.0") }</li>
                        <li>{ t("sections.1.b_items.1") }</li>
                        <li>{ t("sections.1.b_items.2") }</li>
                        <li>{ t("sections.1.b_items.3") }</li>
                    </ul>
